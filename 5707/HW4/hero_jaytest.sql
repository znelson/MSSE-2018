...
/**
drop table HW4_HERO_CARD_W_TEAM;
drop table HW4_Team_Avg_Attack;
...
/**
drop table HW4_HERO_CARD_W_GENDER;
drop table HW4_HERO_CARD_FEM_RAN_OR_REF;
drop table HW4_HERO_CARD_FEM_RRCLAS_CNT;
drop table HW4_HERO_CARD_FEM_RAN_N_REF;
drop table HW4_HERO_FEM_RAN_N_REF;
...
/**
drop table HW4_HERO_CARD_W_GENDER;
drop table HW4_HERO_CARD_MALE;
drop table HW4_HERO_CARD_FEMALE;
drop table HW4_HERO_CARD_GENDERMIX_PAIR;
drop table HW4_HERO_CARD_GEN_CLA_TEAM;
drop table HW4_HERO_CARD_GEN_CLA_TEAM_RES;
exec ops.go(ops.mjoin_ra('HERO_CARD','HERO','HERO','HERO_NAME','HW4_HERO_CARD_W_GENDER'));
...
/**
drop table HW4_HERO_CARD_STR;
drop table HW4_HERO_CARD_REF;
drop table HW4_HERO_CARD_RAN;
drop table HW4_HERO_CARD_INT;
drop table HW4_HERO_CARD_TEC;
drop table HW4_HERO_CARD_STR_CLA_COST;
drop table HW4_HERO_CARD_REF_CLA_COST;
drop table HW4_HERO_CARD_RAN_CLA_COST;
drop table HW4_HERO_CARD_INT_CLA_COST;
drop table HW4_HERO_CARD_TEC_CLA_COST;
drop table HW4_HERO_CARD_CLASS_SR;
drop table HW4_HERO_CARD_CLASS_SRR;
drop table HW4_HERO_CARD_CLASS_SRRI;
drop table HW4_HERO_CARD_CLASS_SRRIT;
drop table HW4_HERO_CARD_CLASS_MIX_W_COST;
...
drop table HW4_HERO_CARD_W_RECRUIT;
drop table HW4_HERO_CARD_W_RECRUIT1;
drop table HW4_HERO_CARD_W_RECRUIT2;
drop table HW4_HERO_CARD_W_RECRUIT3;
drop table HW4_HERO_CARD_W_RECRUIT_C12;
drop table HW4_HERO_CARD_W_RECRUIT_C123;
drop table HW4_HERO_CARD_SET3_W_TOT_REC;
drop table HW4_HERO_CARD_RECRUIT_RES;
drop table HW4_HERO_CARD_BEST_RECR_SET3;
