...
DROP TABLE HW4_GENDER_BALANCED_COMBO;
exec ops.go(ops.filter_ra('HW4_HERO_COMBO_W_ALL_STAT','HERO_COUNT=6 AND FEMALE_HERO_COUNT=3 AND (AVENGERS_CARD_TYPE_COUNT=12 OR SPIDERFRIENDS_CARD_TYPE_COUNT=12 XMEN_CARD_TYPE_COUNT=12 OR SHIELD_CARD_TYPE_COUNT=12)','HW4_TEMP1'));
exec ops.go(ops.project_ra('HW4_TEMP1','COMBO_ID, FEMALE_HERO_COUNT, AVENGERS_CARD_TYPE_COUNT, SPIDERFRIENDS_CARD_TYPE_COUNT, XMEN_CARD_TYPE_COUNT, SHIELD_CARD_TYPE_COUNT','HW4_GENDER_BALANCED_COMBO'));
